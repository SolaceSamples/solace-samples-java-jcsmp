...
public class CustomTextMapGetter implements TextMapGetter<Object> {
	...
	public String get(Object map, String key) {
		  ...
		  String traceId = ((Map<String, String>)map).get("otel_parent_trace_id").toString();		    		
		  String spanId = ((Map<String, String>)map).get("otel_parent_span_id").toString();
